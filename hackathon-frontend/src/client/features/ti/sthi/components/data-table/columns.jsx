...
export const getColumns = () => {
    return [
        ...
        },
        {
            ...
            cell: ({ row }) => <div>{row.getValue('mcp')}</div>,
            enableSorting: false,
        },
        {
            accessorKey: 'pkg',
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('xvi_tool_type')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('thermal_tech')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('sw_platform')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('lts_ball')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('fusion_or_apse')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
        {
            ...
            cell: ({ row }) => {
                return <div>{row.getValue('socket_type')}</div>;
            },
            filterFn: 'includesString',
            enableSorting: false,
        },
